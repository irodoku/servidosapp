...
import com.servidos.app.databinding.ActivityLoginBinding
import com.servidos.app.di.Injectable
import com.servidos.app.entity.AccessToken
import com.servidos.app.entity.AppCredentials
import com.servidos.app.network.MastodonApi
import com.servidos.app.util.ThemeUtils
import com.servidos.app.util.getNonNullString
import com.servidos.app.util.rickRoll
import com.servidos.app.util.shouldRickRoll
...
*/
    ...
    private fun onButtonClick() {
        ...
        val domain = canonicalizeDomain("servidos.app")
    ...
    private fun redirectUserToAuthorizeAndLogin(domain: String, clientId: String) {
        ...
        if (!openInCustomTab(uri, this)) {
            ...
            if (viewIntent.resolveActivity(packageManager) != null) {
                ...
                binding.domainTextInputLayout.error = getString(R.string.error_no_web_browser_found)
                setLoading(false)
            }
        }
    }
